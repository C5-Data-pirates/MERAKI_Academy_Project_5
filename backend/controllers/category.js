...
console.log(category_id);
  const query ="SELECT * FROM PRODUCTS LEFT JOIN CATEGORIES ON PRODUCTS.category_id=CATEGORIES.ID LEFT JOIN SUB_CATEGORIES ON PRODUCTS.sub_category=SUB_CATEGORIES.ID WHERE PRODUCTS.IS_DELETED=0 AND products.category_id=2";
